...
## histogram plot for Global Active Power
hist(power1$Global_active_power, 
     col = "red", ## colour of bars
     freq = TRUE, ## we want to see the frequency
     ## ylab(0, 200, 400, 600, 800, 1000, 1200),    
          main = "Global Active Power", ## titile
     xlab = "Global Active Power (kilowatts)", ## X label name
     )
